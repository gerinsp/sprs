...
class Kepsek extends CI_Controller
{
    ...
    public function permintaan()
    {
        ...
        $data['ruangan'] = $this->db
            ->select('pinjam_ruangan.id_pinjam_ruangan, user.nama AS peminjam, pinjam_ruangan.waktu AS waktu_acara, pinjam_ruangan.created_at AS waktu_pinjam, ruangan.nama AS nama_ruangan,  pinjam_ruangan.acara,  pinjam_ruangan.kebutuhan,  pinjam_ruangan.keterangan')
    ...
    public function peminjaman()
    {
        ...
        $data['ruangan'] = $this->db
            ...
            pinjam_ruangan.waktu AS waktu_acara, pinjam_ruangan.created_at AS waktu_pinjam, ruangan.nama AS nama_ruangan,  pinjam_ruangan.acara,  pinjam_ruangan.kebutuhan,  pinjam_ruangan.keterangan, penerima.nama AS penerima')
    ...
    public function status_peminjaman_kendaraan()
    {
        ...
        $data['kendaraan'] = $this->db
            ...
            penerima.id_role as id_penerima, pinjam_kendaraan.is_finish, 
            pinjam_kendaraan.waktu AS waktu_pinjam, kendaraan.nama AS nama_kendaraan, pinjam_kendaraan.kilometer_awal, 
    ...
    public function status_peminjaman_ruangan()
    {
        ...
        $data['ruangan'] = $this->db
            ->select('peminjam.nama AS peminjam, penerima.id_role as id_penerima, pinjam_ruangan.is_finish,
             pinjam_ruangan.waktu AS waktu_acara, pinjam_ruangan.created_at AS waktu_pinjam, ruangan.nama AS nama_ruangan,  pinjam_ruangan.acara,  pinjam_ruangan.kebutuhan,  pinjam_ruangan.keterangan, penerima.nama AS penerima, pinjam_ruangan.status, pinjam_ruangan.pesan')
            ->join('user peminjam', 'peminjam.id_user = pinjam_ruangan.id_peminjam')
            ->join('user penerima', 'penerima.id_user = pinjam_ruangan.id_user_confirm')
            ->join('ruangan', 'ruangan.id_ruangan = pinjam_ruangan.id_ruangan')
            ->where('is_finish', 1)

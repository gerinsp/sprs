            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="shadow card">
                        <div class="card-body">
                            <form action="<?php echo base_url($this->session->userdata('menu')) . '/barang-save'; ?> " method="post" accept-charset="utf-8" aria-hidden="true">
                                ...
                                <div class="row" style="margin-top:10px">
                                    ...
                                    <div class="col-md-5">
                                        <input class="form-control" required name="kode" id="kode" type="text">
                                    </div>
                                </div>
                                <div class="row" style="margin-top:10px">
                                    <div class="col-md-2">
                                ...
                                <div class="row" style="margin-top:10px">
                                    ...
                                    <div class="col-md-5">
                                        <select class="select2" name="kondisi" id="kondisi" style="width: 100%" required>
                                            <option value="" disabled selected>Placeholder dari script</option>

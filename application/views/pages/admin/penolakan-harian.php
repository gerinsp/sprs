            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="shadow card">
                        <div class="card-body">
                            <form action="<?php echo base_url($this->session->userdata('menu')) . '/tolak-harian/' . $barang->id_pinjam_barang; ?>" method="post" accept-charset="utf-8" aria-hidden="true">

            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="shadow card">
                        <div class="card-body">
                            <form action="<?php echo base_url($this->session->userdata('menu')) . '/supir-save'; ?>" enctype="multipart/form-data" method="post" accept-charset="utf-8" aria-hidden="true">
                                ...
                                <div class="row" style="margin-top:10px">
                                    ...
                                    <div class="col-md-5">
                                        <input class="form-control" required name="ttl" id="ttl" type="text">
                                    </div>
                                </div>
                                <div class="row" style="margin-top:10px">
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-md-5">
                                        <input class="form-control" required name="foto_sim" id="foto_sim" type="file">
                                    </div>
                                </div>
                                <div class="row" style="margin-top:10px">
                                ...
                                <table style="border-collapse: 1;color: #858796;border-bottom: 2px solid #e3e6f0;" id="dataTable" class="table tablelist table-bordered table-striped" width="100%" height="1px" cellspacing="0">
                                    <thead>
                                        <tr height="20px">
                                            ...
                                            <th style=" padding: 0.75rem;vertical-align: top;border-top: 1px solid #e3e6f0;">Tempat, Tanggal Lahir</th>
                                            <th style=" padding: 0.75rem;vertical-align: top;border-top: 1px solid #e3e6f0;">Foto SIM</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td style="vertical-align: top;border-top: 1px solid #e3e6f0;" width="12%"><?php echo $data->ttl ?></td>
                                                <td style="vertical-align: top;border-top: 1px solid #e3e6f0;" width="12%">
                                                    <img src="<?php echo $data->foto_sim ?>" alt="<?php echo $data->nama ?>" width="60%">
                                                </td>
                                            </tr>
                                        <?php
                                            $no++;
